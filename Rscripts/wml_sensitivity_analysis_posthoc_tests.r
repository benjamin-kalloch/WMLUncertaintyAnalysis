...
args=c('/media/simulations/WML/analysis/CSV/wholebrain/FAZEKAS1_wholebrain_stats_summary.csv','/media/simulations/WML/analysis/CSV/wholebrain/FAZEKAS2_wholebrain_stats_summary.csv','/media/simulations/WML/analysis/CSV/wholebrain/FAZEKAS3_wholebrain_stats_summary.csv')
#~ args=c('/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS1_wholebrain_stats_summary.csv','/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS2_wholebrain_stats_summary.csv','/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS3_wholebrain_stats_summary.csv')
...
#~ args=c('/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS1_M1_atlasbased_left_stats_summary.csv','/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS2_M1_atlasbased_left_stats_summary.csv','/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS3_M1_atlasbased_left_stats_summary.csv')
reader<-DataProvider(args,TRUE)
all_data<-reader$stacked_input
all_data$subjectID<-NULL
#~ pairwise.t.test(all_data$scalp,all_data$group, p.adj="bonf")     # normalized sobol indices
...
args=c('/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS1_ROI1_stats_summary.csv','/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS2_ROI1_stats_summary.csv','/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS3_ROI1_stats_summary.csv')
reader<-DataProvider(args,TRUE)
all_data<-reader$stacked_input
all_data$subjectID<-NULL
print("ROI1: scalp")
...
#~ args=c('/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS1_ROI2_stats_summary.csv','/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS2_ROI2_stats_summary.csv','/media/simulations/WML/analysis/CSV/non-normalized_sobol_indices/FAZEKAS3_ROI2_stats_summary.csv')
reader<-DataProvider(args,TRUE)
all_data<-reader$stacked_input
all_data$subjectID<-NULL
print("ROI2: scalp")
