...
#
# This script uses ParaView and the custom plugin "InterpolateToSurface"
# to interpolate the electrical potential and electrical field onto the
# cortical midlayer surface.
#
# This script requires OpenFOAM v7. with the included ParaView 5.6
# with Python support enabled.
# Note: 1) It assumes that OpenFOAM is installed in your HOME directory.
#       2) Adjust the path to INTERP_SURFACE_PLUGIN.
#
...
#### CONSTANTS #####
INTERP_SURFACE_PLUGIN=/PATH/TO/PVInterpolateToSurface/build/libInterpolateToSurface.so

FOAM_READER_PLUGIN=$HOME/OpenFOAM/OpenFOAM-7/platforms/linux64GccDPInt32Opt/lib/paraview-5.6/libPVFoamReader_SM.so
LIBVTKPQCORE=$HOME/OpenFOAM/ThirdParty-7/build/linux64Gcc/ParaView-5.6.0/lib/libvtkpqCore-pv5.6.so.1
PVPYTHON=$HOME/OpenFOAM/ThirdParty-7/platforms/linux64Gcc/ParaView-5.6.0/bin/pvpython
OPENFOAM_BASHRC=$HOME/OpenFOAM/OpenFOAM-7/etc/bashrc
...
openfoam_case.MeshParts = ['cellZone_0 - cellZone', 'cellZone_6 - cellZone', 'cellZone_7 - cellZone'];
